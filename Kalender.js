	...
	for (var i = 1; i <= 42; i++)
	{
		...
		if (i >= dateDay && isValidDate(y,m,zahl))		
		{
				...
				hD.getYear() == dx.getYear())
			{
				...
				entry.style.backgroundColor = 'rgb(119,136,153)';
			}
...
/**
 * Pr�ft ob an einem bestimmten Tag ein Event stattfindet
 * und gibt dieses als Text zur�ck.
 * @param int y: Jahr
 * @param int m: Monat
 * @param int d: tag
...
function getEventtext(y,m,d)
{
    ...
    // h[eintragnummer aufsteigend]= "datum|Was|Wo";
	h[0] = "8.6.2020|Infostand, Hiltrup";
	h[1] = "20.6.2020|Münster SPD Parteitag, Mensa am Ring";
